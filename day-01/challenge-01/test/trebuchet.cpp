...
int main()
{
    ...
    trebuchetCalibration TCalibrate1("/home/peter/Coding/AdventOfCode/day-01/challenge-01/test/test01.txt");
    if (TCalibrate1.getCalibrationData() != 281) return -1;

    trebuchetCalibration TCalibrate2("/home/peter/Coding/AdventOfCode/day-01/challenge-01/test/test02.txt");
    if (TCalibrate2.getCalibrationData() != 104) return -1;

    trebuchetCalibration TCalibrate3("/home/peter/Coding/AdventOfCode/day-01/challenge-01/test/test03.txt");
